...
import { Save, User, Mail, Phone, MapPin, Calendar, Shield } from 'lucide-react';

const AdminProfile: React.FC = () => {
  const [email, setEmail] = useState('admin@smilesmarthome.in');
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 flex flex-col items-center">
          <div className="h-24 w-24 rounded-full bg-teal-500 flex items-center justify-center mb-4">
            <User className="h-12 w-12 text-white" />
          </div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">{name}</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Administrator</p>
          ...
          <div className="w-full space-y-3">
            ...
            <div className="flex items-center text-sm">
              ...
              <span className="text-gray-600 dark:text-gray-300">Role: Administrator</span>
            </div>
          </div>
        </div>
