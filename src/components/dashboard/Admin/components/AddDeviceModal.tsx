                ...
                <td className="py-3 pr-4">
                  {assignedIds.includes(device.id) ? (
                    <button
                      ...
                      className="inline-flex items-center justify-center min-w-[96px] px-3 py-2 text-sm font-medium rounded-md bg-red-600 hover:bg-red-700 text-white focus:outline-none focus:ring-2 focus:ring-red-500"
                    >
                      Remove
                    </button>
                  ) : (
